    ...
    BoxWithConstraints(
        ...
        if (maxWidth >= 768.dp) {
            TabletSettingsScreen(
                ...
                homescreenHeroNotificationsIconEnabled = homescreenSettingsUiState.heroNotificationsIconEnabled,
                homescreenHeroDownloadsIconEnabled = homescreenSettingsUiState.heroDownloadsIconEnabled,
...
private fun MobileSettingsScreen(
    ...
    homescreenHeroNotificationsIconEnabled: Boolean,
    homescreenHeroDownloadsIconEnabled: Boolean,
        ...
        NuvioScreen(
            ...
            when (page) {
                ...
                SettingsPage.Homescreen -> homescreenSettingsContent(
                    ...
                    downloadsIconEnabled = homescreenHeroDownloadsIconEnabled,
